...
Documentação das páginas e componentes do V-Commerce CRM 360, construído em **React + TypeScript (Vite)**.
...
| Arquivo | Descrição |
|---|---|
| [Componentes](./components-doc.md) | Átomos, moléculas e organismos reutilizáveis |

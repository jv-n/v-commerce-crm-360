...
def export_contacts_csv(
    ...
    stream = ContactService(db).export_contacts_csv(
        ...
        ticket_medio_min=ticket_medio_min, ticket_medio_max=ticket_medio_max,
        primeira_compra_from=primeira_compra_from, primeira_compra_to=primeira_compra_to,
        ultima_compra_from=ultima_compra_from, ultima_compra_to=ultima_compra_to,
        tickets_suporte_min=tickets_suporte_min, tickets_suporte_max=tickets_suporte_max,
        nota_atend_min=nota_atend_min, nota_atend_max=nota_atend_max,
        nps_min=nps_min, nps_max=nps_max,
        nota_prod_min=nota_prod_min, nota_prod_max=nota_prod_max,
        generos=generos, faixas_etarias=faixas_etarias, estados=estados,
        canais_preferidos=canais_preferidos, dispositivos=dispositivos,
        origens_sessao=origens_sessao, periodos_dia=periodos_dia,
        dias_semana=dias_semana, categorias_visualizadas=categorias_visualizadas,
        taxa_conversao_min=taxa_conversao_min, taxa_conversao_max=taxa_conversao_max,
        total_sessoes_min=total_sessoes_min, total_sessoes_max=total_sessoes_max,
        abandono_carrinho_min=abandono_carrinho_min, abandono_carrinho_max=abandono_carrinho_max,
        nps_recente_min=nps_recente_min, nps_recente_max=nps_recente_max,
    )

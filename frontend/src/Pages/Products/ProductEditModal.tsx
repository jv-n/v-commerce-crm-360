...
const STATUSES = ["Ativo", "Novo", "Inativo", "Descontinuado"]
...
export function ProductEditModal({ open, product, onClose, onSuccess, onDeleted }: ProductEditModalProps) {
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-3 gap-4 items-end">
              ...
              <FieldBlock label="Avaliação" muted>
                <input
                  className={cn(inputCls, "text-gray-400 cursor-not-allowed")}

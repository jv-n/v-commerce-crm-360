  ...
  return (
    <div className="relative p-6 h-full flex flex-col gap-5 bg-white min-h-full rounded-xl">
      <div className="flex items-center justify-between">
        <h1 className="text-[40px] font-bold text-gray-900">Pedidos</h1>
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => tableRef.current?.openAdd()} className="flex items-center gap-2 bg-[#F7EBFF] border border-[#D1B1E5] rounded-lg px-4 py-2 text-sm font-medium text-gray-700 hover:bg-[#F0DDFD] shadow-sm transition-colors">
